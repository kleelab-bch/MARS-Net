...
if __name__ == '__main__':
    ...
    img_folder = '../assets/'
    mask_folder = '../vUnet/average_hist/predict_wholeframe_teacher/'
    saved_folder = '../assets_expand/'
    for index in range(0, len(dataset), 1):
        img_path = img_folder + dataset[index] + '/img/'
        msk_path = mask_folder + dataset[index] + '/2_0_' + dataset[index] + '/'
        ...
        #Save the image back.
        img_path = saved_folder + dataset[index] + '_pred/img/'
        msk_path = saved_folder + dataset[index] + '_pred/mask/'
